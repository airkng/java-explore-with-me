...
public class PrivCommentController {
    ...
    public CommentResponseDto addComment(@PathVariable(value = "userId") final Long userId,
        ...
        log.debug("Create comment by user. Params: user id = '{}', event id = '{}', body = {} .Controller: PrivCommentController. Endpoint: POST /users/{userId}/comments", userId, eventId, commentDto);
    ...
    public List<CommentResponseDto> getAllCommentByUser(@PathVariable(value = "userId") final Long userId,
        ...
        log.debug("Get all comments by user. Params: user id = '{}', from = '{}', size = '{}'. Controller PrivCommentController. Endpoint: GET /users/{userId}/comments", userId, from, size);
    ...
    public CommentResponseDto updateComment(@PathVariable(value = "userId") final Long userId,
                                            ...
                                            @Valid @RequestBody final CommentRequestDto commentDto) {
        log.debug("Update comment by user. Params: user id = '{}', comment id = '{}', body = {} .Controller: PrivCommentController. Endpoint: PATCH /users/{userId}/comments", userId, commentId, commentDto);
    ...
    public void deleteComment(@PathVariable(value = "userId") final Long userId,
                              @PathVariable(value = "commentId") final Long commentId) {
        log.debug("Delete comment by user. Params: user id = '{}', comment id = '{}'.Controller: PrivCommentController. Endpoint: DELETE /users/{userId}/comments", userId, commentId);
